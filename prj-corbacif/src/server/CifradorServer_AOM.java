...
public class CifradorServer_AOM {
	...
	public static void main(String[] args) {
		...
		try {
			...
			POA poa = poaRoot.create_POA("CifradorServerImpl_poa",	poaRoot.the_POAManager(), policies);

			// Create the servant
			CifradorServerImpl servant = new CifradorServerImpl();

			// Activate the servant with the ID on myPOA
			byte[] objectId = "MiCifrador".getBytes();
			...
			// ---- Uncomment below to enable Naming Service access. ----
			 ...
			 nc.rebind(nc.to_name("MiCifrador"), obj);
