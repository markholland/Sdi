...
// IDL:corba/Echo:1.0
//
final public class EchoHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Echo val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Echo");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _EchoStub _ob_stub = new _EchoStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Echo val)
    {
